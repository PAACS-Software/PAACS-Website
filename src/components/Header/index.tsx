    ...
    <header
      className={`header left-0 top-0 z-40 flex w-full items-center ${
        sticky
          ...
          : "absolute z-[9999] bg-transparent"
      }`}
    >
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
                        ...
                        <>
                          ...
                          >
                            {menuItem.submenu?.map(
                              (submenuItem: any, sIdx: number) => (
                                <Link
                                  href={submenuItem.path}
                                  onClick={() => setNavbarOpen(false)}
                                  key={sIdx}
                                  className="text-dark hover:text-primary block rounded py-2.5 text-sm lg:px-3 dark:text-white/70 dark:hover:text-white"
                                >
                                  {submenuItem.title}
                                </Link>
                              ),
            ...
            <div className="flex items-center justify-end pr-16 lg:pr-0">
              ...
              <Link
                href="https://user.paacs.pro/signup"
                className="ease-in-up bg-primary shadow-btn hover:shadow-btn-hover hidden rounded-sm px-8 py-3 text-base font-medium text-white transition duration-300 hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9"
              >
                Sign Up
              </Link>
              <div>
