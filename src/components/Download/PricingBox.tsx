const PricingBox = (props: {
  ...
  packageName: string;
  subtitle: string;
  downloadLink: string; // New prop for download URL
  children: React.ReactNode;
}) => {
  const { price, duration, packageName, subtitle, downloadLink, children } =
    props;
    ...
    <div className="w-full">
      <div className="relative z-10 rounded-sm bg-white px-8 py-10 shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark">
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
          <a
            href={downloadLink} // Use the passed download link
